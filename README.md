# Linear_regression
Python implementation of simple linear regression to predict a car's price based on its mileage 🚗

![Screen Shot 2022-12-03 at 5 04 44 PM](https://user-images.githubusercontent.com/94646532/205450246-37f965bf-0e5c-413d-992f-44692cff09d1.png)

Regression models describe relationship between a dependent variable and independent variable(s).
We will use simple linear regression to predict the price of a car based on its mileage.
